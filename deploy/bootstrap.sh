...
SINGBOX_REPO="${SINGBOX_REPO:-https://github.com/hoaxisr/amnezia-box.git}"
SINGBOX_REF="${SINGBOX_REF:-main}"
SINGBOX_SRC_DIR="${SINGBOX_SRC_DIR:-/usr/local/src/amnezia-box}"
GO_VERSION="${GO_VERSION:-1.24.7}"
SINGBOX_BUILD_TAGS="${SINGBOX_BUILD_TAGS:-with_gvisor with_quic with_dhcp with_wireguard with_utls with_acme with_clash_api with_awg}"
